...
<script type="text/javascript" src="{{< cdn "/2011-06-04-jclouds/jquery.clouds-0.2.js" >}}"></script>
<script type="text/javascript">
    $(document).ready(function(){
        
        $('#clouds').clouds({
                            xmlMap: '{{< cdn "/2011-06-04-jclouds/clouds.xml" >}}',
                            bobHeight: 0,
                            speed: 20
                            });
                            
        $('#clouds').clouds({
                            xmlMap: '{{< cdn "/2011-06-04-jclouds/misc.xml" >}}',
                            cloudCount: 1,
                            bobHeight: 10
                            });
    });
