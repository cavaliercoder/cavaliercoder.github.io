...
<a class="lightbox" href="{{< cdn "/2015-10-06-testing-zabbix-actions/add-item.png" >}}">
    <img class="osx-window" src="{{< cdn "/2015-10-06-testing-zabbix-actions/add-item.png" >}}" alt="Add an item">
</a>
...
<a class="lightbox" href="{{< cdn "/2015-10-06-testing-zabbix-actions/add-trigger.png" >}}">
    <img class="osx-window" src="{{< cdn "/2015-10-06-testing-zabbix-actions/add-trigger.png" >}}" alt="Add an item">
</a>
...
<a class="lightbox" href="{{< cdn "/2015-10-06-testing-zabbix-actions/add-media-type.png" >}}">
    <img class="osx-window" src="{{< cdn "/2015-10-06-testing-zabbix-actions/add-media-type.png" >}}" alt="Add an item">
</a>
...
<a class="lightbox" href="{{< cdn "/2015-10-06-testing-zabbix-actions/add-media.png" >}}">
    <img class="osx-window" src="{{< cdn "/2015-10-06-testing-zabbix-actions/add-media.png" >}}" alt="Add an item">
</a>
...
<a class="lightbox" href="{{< cdn "/2015-10-06-testing-zabbix-actions/add-action-conditions.png" >}}">
    <img class="osx-window" src="{{< cdn "/2015-10-06-testing-zabbix-actions/add-action-conditions.png" >}}" alt="Add an item">
</a>
...
<a class="lightbox" href="{{< cdn "/2015-10-06-testing-zabbix-actions/add-action-operation.png" >}}">
    <img class="osx-window" src="{{< cdn "/2015-10-06-testing-zabbix-actions/add-action-operation.png" >}}" alt="Add an item">
</a>
