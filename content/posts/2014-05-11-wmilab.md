...
<div>
  <a class="lightbox" href="{{< cdn "/2014-05-11-wmilab/browse.png" >}}">
    <img class="thumb" src="{{< cdn "/2014-05-11-wmilab/browse.png" >}}" alt="Browse WMI namespaces" />
  </a>
  <a class="lightbox" rel="screenshots" href="{{< cdn "/2014-05-11-wmilab/query.png" >}}">
    <img class="thumb"  src="{{< cdn "/2014-05-11-wmilab/query.png" >}}" alt="Execute WQL query" />
  </a>
  <a class="lightbox" rel="screenshots" href="{{< cdn "/2014-05-11-wmilab/code.png" >}}">
    <img class="thumb"  src="{{< cdn "/2014-05-11-wmilab/code.png" >}}" alt="Generate scripts" />
  </a>
</div>
